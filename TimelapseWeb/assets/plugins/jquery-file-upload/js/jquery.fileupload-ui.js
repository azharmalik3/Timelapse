...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
            ...
            destroy: function (e, data) {
                ...
                that._transition(data.context).done(
                    function () {
                        ...
                        $(this).remove();
                        //$(".PreviewLogo").html('');
                        //if ($("#imgWatermarkLogo").attr('src') != '')
                        //    $("#imgPreviewLogo").html('<img src="' + $("#imgWatermarkLogo").attr('src') + '" style="width:40px;" />')
        ...
        _renderLogoPreview: function (file, node) {
            var that = this,
                options = this.options,
                dfd = $.Deferred();
            return ((loadImage && loadImage(
            ...
            data.context.find('.preview span').each(function (index, element) {
                ...
                if (options.previewSourceFileTypes.test(file.type) &&
                    ...
                    that._processingQueue = that._processingQueue.pipe(function () {
                        ...
                        //$("#imgPreviewLogo").html('');
                        //that._renderLogoPreview(file, $(".PreviewLogo")).done();
                        //$(".PreviewLogo canvas").addClass("logo-position");
        ...
        _cancelHandler: function (e) {
            ...
            $(".fileupload-buttonbar").slideDown();
            //$(".PreviewLogo").html('');
            //if ($("#imgWatermarkLogo").attr('src') != '')
             //   $("#imgPreviewLogo").html('<img src="' + $("#imgWatermarkLogo").attr('src') + '" style="width:40px;" />')
        },
